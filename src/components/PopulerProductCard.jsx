...
export default function PopulerProductCard({ name, imgURL, price }) {
 return (
  <div className="flex flex-1  flex-col max-sm:w-full max-sm:flex-row max-sm:gap-6  max-sm:pl-4 max-sm:items-center ">
   ...
   <div>
    <div className="flex mt-8 max-sm:mt-0 justify-start gap-2.5 items-center  ">
    ...
    <p className="text-2xl font-montserrat text-coral-red  mt-2">{price}</p>
   </div>
  </div>
 )
}
